...
Below is a snapshot of the interactive Power BI dashboard built using data from the PostgreSQL database generated by this ETL pipeline.

![Power BI Dashboard](assets/powerbi_dashboard.png)

### Dashboard Highlights
- Average combat intensity by oblast
- Total casualties, injured, and captured KPIs
- Civilian casualties and territory occupied metrics
- Event breakdown by country
- Yearly soldier casualty trends
- Interactive slicers for date, country, oblast, and event type
